              ...
              $.ajax({
                  ...
                  var tabla = $("#example1").DataTable({
                      ...
                      "columns": [{
                          ...
                          //             '<i class="fa fa-eye"></i>' + 
                          //         '</a>' + 
                          //         '<a href="javascript:void(0)" style="margin-right: 5px;" class="btn bg-info btnEditar" onclick="editar(this,' + data.id_votante_centro_votacion + ')"  title="Actualizar" type="button">' + 
                          //             '<i class="fa fa-edit" style="color: white;"></i>' + 
                          //         '</a>' + 
                          //         '<a href="javascript:void(0)" style="margin-right: 5px;" class="btn bg-danger mensaje-eliminar" title="Eliminar">' + 
                          //             '<i class="fa fa-trash"></i>' + 
                          //         '</a>' + '<p style="display: none;">' + data.id_votante_centro_votacion + '</p>' + '</td>';
                          //     }
                          // },
                      ],
                      "responsive": true,
