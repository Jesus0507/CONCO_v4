...
segundo_nombre.onkeyup = function() {
    valid_element("Debe ingresar el segundo nombre de la persona", segundo_nombre, document.getElementById("valid_3"));
}
...
segundo_apellido.onkeyup = function() {
    valid_element("Debe ingresar el segundo apellido de la persona", segundo_apellido, document.getElementById("valid_5"));
}
...
function enviar_informacion() {
    ...
    $.ajax({
        ...
        url: BASE_URL + "app/Direcciones.php",
        data: {
            direction: "Personas/registrar_persona_habitante",
            accion: "codificar"
        },
        success: function(direccion_segura) {
            $.ajax({
    ...
    $.ajax({
        ...
        success: function(direccion_segura) {
            $.ajax({
                ...
                url: BASE_URL + direccion_segura,
                data: {
                    "cedula_propietario": cedula.value,
                    "descripcion_transporte": tipo_transporte.value
                }
            });
        },
        error: function() {
