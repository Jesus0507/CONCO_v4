    ...
    swal({
        ...
        if (isConfirm) {
            $.ajax({
                ...
                data: {
                    direction: "Personas/eliminacion_logica",
                    accion: "codificar"
                },
...
function editar_datos(persona, ocupacion, condicion_lab, transporte, bonos, misiones, proyectos, comunidad_i, org_politica) {
    ...
    if (bonos_info.length == 0) {
        ...
        vbonos.innerHTML = "";
        for (var i = 0; i < bonos_info.length; i++) {
            var tabl = vbonos.innerHTML += " <table style='width:95%'><tr><td>- " + bonos_info[i]["nombre_bono"] + "</td><td style='text-align:right'><span onclick='borrar_bono(" + bonos_info[i]['id_persona_bono'] + ",`" + persona_info['cedula_persona'] + "`)' class='iconDelete fa fa-times-circle' title='Eliminar bono' style='font-size:22px'></span></td></tr></table><br><hr>";
        }
    }
    if (misiones_info.length == 0) {
    ...
    if (proyectos_info.length == 0) {
        ...
        var texto = "";
        texto += "<table style='width:100%' border='1'><tr style='background:grey;color:white'><td style='width:25%'>Nombre</td><td style='width:25%'>Área</td><td style='width:25%'>Estado</td><td style='width:25%'>Eliminar</td></tr>";
        for (var i = 0; i < proyectos_info.length; i++) {
            texto += "<tr><td style='width:25%'>" + proyectos_info[i]["nombre_proyecto"] + "</td><td style='width:25%'>" + proyectos_info[i]["area_proyecto"] + "</td>";
            texto += "<td style='width:25%'>" + proyectos_info[i]["estado_proyecto"] + "</td><td style='width:25%;text-align:center'><span onclick='borrar_proyecto(" + proyectos_info[i]['id_persona_proyecto'] + ",`" + inf_persona['cedula_persona'] + "`)' class='iconDelete fa fa-times-circle' title='Eliminar proyecto' style='font-size:22px'></span></td></tr>";
        }
...
function editar_persona() {
    $.ajax({
        ...
        url: BASE_URL + "app/Direcciones.php",
        data: {
            direction: "Personas/modificar_persona",
            accion: "codificar"
        },
        success: function (direccion_segura) {
            $.ajax({
    ...
    swal({
        ...
        if (isConfirm) {
            $.ajax({
                ...
                url: BASE_URL + "app/Direcciones.php",
                data: {
                    direction: "Personas/eliminar_bono",
                    accion: "codificar"
                },
                success: function (direccion_segura) {
                    $.ajax({
        ...
        $.ajax({
            ...
            success: function (direccion_segura) {
                $.ajax({
                    ...
                    url: BASE_URL + direccion_segura,
                    data: {
                        "cedula_persona": inf_persona['cedula_persona'],
                        "bono": document.getElementById("bono_nuevo").value
                    }
                }).done(function (result) {
                    if (result == 0) {
                        swal({
...
function cargar_misiones(cedula_persona) {
    $.ajax({
        ...
        url: BASE_URL + "app/Direcciones.php",
        data: {
            direction: "Personas/get_misiones",
            accion: "codificar"
        },
        success: function (direccion_segura) {
            $.ajax({
    ...
    swal({
        ...
        if (isConfirm) {
            $.ajax({
                ...
                url: BASE_URL + "app/Direcciones.php",
                data: {
                    direction: "Personas/eliminar_mision",
                    accion: "codificar"
                },
                success: function (direccion_segura) {
                    $.ajax({
            ...
            $.ajax({
                ...
                success: function (direccion_segura) {
                    $.ajax({
                        ...
                        url: BASE_URL + direccion_segura,
                        data: {
                            "cedula": inf_persona['cedula_persona'],
                            "mision": mision_data
                        }
                    }).done(function (result) {
                        console.log(result);
...
function cargar_proyectos(cedula_persona) {
    $.ajax({
        ...
        url: BASE_URL + "app/Direcciones.php",
        data: {
            direction: "Personas/get_proyectos",
            accion: "codificar"
        },
        success: function (direccion_segura) {
            $.ajax({
                ...
                if (result != 0) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        texto += "<table style='width:100%' border='1'><tr style='background:grey;color:white'><td style='width:25%'>Nombre</td><td style='width:25%'>Área</td><td style='width:25%'>Estado</td><td style='width:25%'>Eliminar</td></tr>";
                        for (var i = 0; i < result.length; i++) {
                            texto += "<tr><td style='width:25%'>" + result[i]["nombre_proyecto"] + "</td><td style='width:25%'>" + result[i]["area_proyecto"] + "</td>";
                            texto += "<td style='width:25%'>" + result[i]["estado_proyecto"] + "</td><td style='width:25%;text-align:center'><span onclick='borrar_proyecto(" + result[i]['id_persona_proyecto'] + ",`" + cedula_persona + "`)' class='iconDelete fa fa-times-circle' title='Eliminar proyecto' style='font-size:22px'></span></td></tr>";
                        }
                        vproyectos.innerHTML += texto + "</table>";
                    }
                } else {
    ...
    swal({
        ...
        if (isConfirm) {
            $.ajax({
                ...
                url: BASE_URL + "app/Direcciones.php",
                data: {
                    direction: "Personas/eliminar_proyecto",
                    accion: "codificar"
                },
                success: function (direccion_segura) {
                    $.ajax({
...
document.getElementById("spanaddproyect").onclick = function () {
    if ((document.getElementById("nuevo_proyecto").value == "0" && document.getElementById("nuevo_proyecto").style.display != "none") || (document.getElementById("nuevo_proyecto").style.display == "none" && (document.getElementById("nombre_proyecto").value == "" || document.getElementById("area_proyecto").value == "0" || document.getElementById("estado_proyecto").value == ""))) {
        ...
        $.ajax({
            ...
            url: BASE_URL + "app/Direcciones.php",
            data: {
                direction: "Personas/add_proyecto",
                accion: "codificar"
            },
            success: function (direccion_segura) {
                $.ajax({
                    ...
                    url: BASE_URL + direccion_segura,
                    data: {
                        "proyecto_info": proyecto_persona,
                        "cedula_persona": inf_persona['cedula_persona']
                    }
                }).done(function (result) {
                    if (result == 0) {
