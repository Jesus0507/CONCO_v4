...
rechazar.onclick = function() {
    var textoSwal = "Está por rechazar la solicitud de un registro de familia ¿desea continuar?<br><br>";
    ...
    swal({
        ...
        if (isConfirm) {
            ...
            if (document.getElementById("text-area").value == "") {
                ...
                datos_notificacion["accion"] = "Rechazó su solicitud para registro de familia debido a :" + document.getElementById("text-area").value + ".";
                ...
                solicitante["mensaje"] = "Su solicitud para registro de familia ha sido rechazada. El motivo del rechazo es: " + motivo_rechazo;
...
aprobar.onclick = function() {
    ...
    datos_notificacion["usuario_receptor"] = document.getElementById("cedula_solicitante").value;
    datos_notificacion["accion"] = "Aprobó su solicitud para registro de familia.";
    solicitante["asunto"] = "Se ha aprobado su solicitud";
    solicitante["mensaje"] = "Su solicitud para registro de familia ha sido aprobada.";
    nueva_notificacion(datos_notificacion);
    if (solicitante["correo"] != "No posee") {
        document.getElementById("btn_correo").click();
    } {
...
function ver_info_integrante(persona) {
    ...
    $.ajax({
        ...
        url: BASE_URL + "app/Direcciones.php",
        data: {
            direction: "Personas/get_info_habitante",
            accion: "codificar"
        },
        success: function(direccion_segura) {
            $.ajax({
                ...
                url: BASE_URL + direccion_segura,
                data: {
                    cedula_persona: persona_info["cedula_persona"]
                },
