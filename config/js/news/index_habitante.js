...
btn_calendario_habitante.onclick = function () {
    index_habitante = 1;
    cambio_vista();
}
btn_solicitar_habitante.onclick = function () {
    index_habitante = 2;
    cambio_vista();
}
btn_registrar_vivienda.onclick = function () {
    index_habitante = 3;
    cambio_vista();
}
btn_registrar_familia.onclick = function () {
    index_habitante = 4;
    cambio_vista();
}
