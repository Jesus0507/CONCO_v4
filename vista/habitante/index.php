                    ...
                    <div class="card-body p-0">
                        <center>
                            ...
                            <div id="formulario-consulta-persona" style="width:80%;display: none">
                                ...
                                <input type="hidden" id='user_cedula' value='<?php echo $_SESSION["cedula_usuario"]; ?>'
                                    name="">
                                ...
                                <textarea id="motivo-solicitud" class="form-control"
                                    placeholder="Indique la razón por la que solicita este documento..."></textarea>
                                <div id="valid_mot" style="color:red"></div>
                                <br>
                                <center><button id="enviar-solicitud" class="btn btn-info">Enviar solicitud</button>
                                </center>
                            </div>
                                                ...
                                                <div class="form-group row justify-content-center">
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="custom-select" id="id_calle"
                                                                name="datos[id_calle]">
                                                                <option value='vacio'>
                                                                    ...
                                                                </option>
                                                                <?php foreach($this->datos["calles"] as $calles){   ?>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <input class="form-control mb-10" id="direccion_vivienda"
                                                                name="datos[direccion_vivienda]" placeholder="Direccion"
                                                                type="text" />
                                                        </div>
                                                    </div>
                                    ...
                                    <input class="form-control mb-10" id="propietario" name="datos[propietario]"
                                        placeholder="Propietario" type="text" />
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <input class="form-control mb-10" id="numero_casa"
                                                                name="datos[numero_casa]"
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        </label> <span id='valid_cantidad_habitaciones'
                                                            style='color:red'></span>
                                                        <div class="input-group">
                                                            <input class="form-control mb-10" id="cantidad_habitaciones"
                                                                name="datos[cantidad_habitaciones]"
                                                                placeholder="Cantidad Habitaciones" type="number" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <input list="tipo_v" id="id_tipo_vivienda"
                                                                name="datos[id_tipo_vivienda]" class="form-control "
                                                                placeholder="Tipo de Vivienda" />
                                                            <datalist id="tipo_v">
                                                                <?php foreach($this->datos["tipo_vivienda"] as $T_VIVIENDA){   ?>
                                                                <option
                                                                    value="<?php echo $T_VIVIENDA["nombre_tipo_vivienda"];?>">
                                                    ...
                                                    <div class="col-md-4     mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="custom-select" id="hacinamiento"
                                                                name="datos[hacinamiento]">
                                                                <option value="1">
                                                                    Si
                                                                </option>
                                                    ...
                                                    <div class="col-md-4     mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="custom-select" id="espacio_siembra"
                                                                name="datos[espacio_siembra]">
                                                                <option value="1">
                                                                    Si
                                                                </option>
                                                                <option value="0" selected>
                                                    ...
                                                    <div class="col-md-4     mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="custom-select" id="banio_sanitario"
                                                                name="datos[banio_sanitario]">
                                                                <option value="1">
                                                                    Si
                                                                </option>
                                                                <option value="0" selected>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="custom-select" id="agua_consumo"
                                                                name="datos[agua_consumo]">
                                                                <option value='vacio'>
                                                                    ...
                                                                </option>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="custom-select" id="aguas_negras"
                                                                name="datos[aguas_negras]">
                                                                <option value="0">
                                                                    ...
                                                                </option>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="custom-select" id="residuos_solidos"
                                                                name="datos[residuos_solidos]">
                                                                <option value='0'>
                                                                    ...
                                                                </option>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="custom-select" id="servicio_electrico"
                                                                name="datos[servicio_electrico]">
                                                                <option value="1">
                                                                    Si
                                                                </option>
                                                                <option value="0" selected>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="custom-select" id="cable_telefonico"
                                                                name="datos[cable_telefonico]">
                                                                <option value="1">
                                                                    Si
                                                                </option>
                                                                <option value="0" selected>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="custom-select" id="insectos_roedores"
                                                                name="datos[insectos_roedores]">
                                                                <option value="1">
                                                                    Si
                                                                </option>
                                                                <option value="0" selected>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <input list="techo" type="text" id="tipo_techo"
                                                                name="tipo_techo[]" placeholder="Tipo Techo"
                                                                class="form-control cedula solo-letras"
                                                                oninput="Limitar(this,50)" />
                                                            <datalist id="techo">
                                                            ...
                                                            <button id='agregar_techo' class="btn btn-info"
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <input list="pared" type="text" id="tipo_pared"
                                                                name="tipo_pared[]" placeholder="Tipo Pared"
                                                                class="form-control cedula solo-letras"
                                                                oninput="Limitar(this,50)" />
                                                            <datalist id="pared">
                                                            ...
                                                            <button id='agregar_pared' class="btn btn-info"
                                                                type="button">Agregar</button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 mt-2">
                                                        ...
                                                        <div class="input-group">
                                                            <input list="piso" type="text" id="tabla_piso"
                                                                name="tipo_piso[]" placeholder="Tipo Piso"
                                                                class="form-control cedula solo-letras"
                                                                oninput="Limitar(this,50)" />
                                                            <datalist id="piso">
                                                            ...
                                                            <button id='agregar_piso' class="btn btn-info"
                                                                type="button">Agregar</button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        ...
                                                        </label> <span id='valid_gases_agregados'
                                                            style='color:red'></span>
                                                        <table style='width:100%'>
                                                            <tr>
                                                                <td>
                                                                    <select id='gas_select' class='form-control'>
                                                                        ...
                                                                        <option
                                                                            value='<?php  echo $gas['id_servicio_gas']?>'>
                                                                            <?php echo $gas['nombre_servicio_gas']; ?>
                                                                        </option>
                                                                        <?php   } ?>
                                                                    </select>
                                                                    <input type="text" maxlength='30'
                                                                        class='form-control'
                                                                        placeholder="Compañía de gas..." name=""
                                                                        id='gas_input' style='display:none'>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <select id='tiempo_duracion' class='form-control'>
                                                                        <option value='vacio'>-Tiempo de duración-
                                                                        </option>
                                                                ...
                                                                <td>
                                                                    <button type="button" name="agregar"
                                                                        id="agregar_servicio"
                                                                        class="btn btn-info">Nuevo</button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan='5'><br>
                                                    ...
                                                    <div class="col-md-12 mt-2">
                                                        ...
                                                        </label> <span id='valid_electrodomesticos_agregados'
                                                            style='color:red'></span>
                                                        <table style='width:100%'>
                                                            <tr>
                                                                <td>
                                                                    <select id='electrodomestico_select'
                                                                        class='form-control'>
                                                                        <option value='vacio'>-Electrodoméstico-
                                                                        </option>
                                                                        <?php foreach ($this->datos["electrodomesticos"] as $e) { ?>
                                                                        <option
                                                                            value='<?php  echo $e['id_electrodomestico']?>'>
                                                                            <?php echo $e['nombre_electrodomestico']; ?>
                                                                        </option>
                                                                        <?php   } ?>
                                                                    </select>
                                                                    <input type="text" maxlength='30'
                                                                        ...
                                                                        name="" id='electrodomestico_input'
                                                                        style='display:none'>
                                                                </td>
                                                                <td> <input type="number" id='cantidad_electrodomestico'
                                                                ...
                                                                <td>
                                                                    <button type="button" name="agregar"
                                                                        id="nuevo_electrodomestico"
                                                                        class="btn btn-info">Nuevo
                                                                        electrodoméstico</button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan='4'><br>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <select class='form-control'
                                                                            id='select-cond-ocupacion'>
                                                                            <option value='0'>-Seleccione-</option>
                                                                            <option value='Adjudicada'>Adjudicada
                                                                            </option>
                                                                            <option value='Alquilada'>Alquilada</option>
                                                                            <option value="Invadida">Invadida</option>
                                                                            <option value='Prestada'>Prestada</option>
                                                                            <option value='Propia pagada'>Propia pagada
                                                                            </option>
                                                                            <option value='Propia pagándose'>Propia
                                                                                pagándose</option>
                                                                        </select>
                                                                        <input style='display:none' type="text"
                                                                            maxlength="20"
                                                                            id='input_condicion_ocupacion'
                                                        ...
                                                        <div class="col-md-6 mt-2">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control mb-10" id="nombre_familia"
                                                                    name="datos[nombre_familia]"
                                                                    placeholder="Nombre de la familia" type="text" />
                                                            </div>
                                                        ...
                                                        <div class="col-md-6 mt-2">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control mb-10" id="telefono_familia"
                                                                    name="datos[telefono_familia]"
                                                                    placeholder="telefono_familia" type="number" />
                                                            </div>
