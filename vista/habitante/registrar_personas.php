                                    ...
                                    <div class="tab-pane active" id="panel1" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-2">
                                                <label for="cedula">
                                                    Documento de identidad </label> <span style='color:red;display:none'
                                                    id='valid_1'>Ingrese el documento de identidad</span>
                                            ...
                                            <div class="col-md-6 mt-4">
                                                ...
                                                <span style='display:none;color:red' id='valid_2'>Ingrese el primer
                                                    nombre</span>
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-6 mt-4">
                                                ...
                                                <span style='display:none;color:red' id='valid_3'>Ingrese el segundo
                                                    nombre</span>
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_4'>Ingrese el primer
                                                    apellido</span>
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_5'>Ingrese el segundo
                                                    apellido</span>
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                <div class="form-group">
                                                    <label for="fecha_nacimiento">
                                                        Fecha De Nacimiento
                                                    </label> <span style='display:none;color:red' id='valid_6'>Ingrese
                                                        la fecha de nacimiento</span>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_7'>Ingrese el estado
                                                    civil </span>
                                                <div class="input-group">
                                                    <select class="custom-select" id="estado_civil"
                                                        name="datos[estado_civil]">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_8'>Ingrese el
                                                    género</span>
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_9'>Ingresela orientación
                                                    sexual</span>
                                                <div class="input-group">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_10'>Ingrese la
                                                    nacionalidad</span>
                                                <div class="input-group">
                                                    <input class="form-control mb-10 solo-letras" id="nacionalidad"
                                                        name="datos[nacionalidad]" placeholder="Nacionalidad"
                                                        type="text" oninput="Limitar(this,20)" />
                                                </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_11'>Ingrese el nivel
                                                    educativo</span>
                                                <div class="input-group">
                                                    <select class='form-control' name="datos[nivel_educativo]"
                                                        id='nivel_educativo'>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_12'>Indique si es
                                                    afrodescendente</span>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control mb-10" id="tiempo_comunidad"
                                                        name="datos[tiempo_comunidad]" type="date" />
                                                    <button type="button" class="btn btn-default"
                                                        id='desde_siempre'>Desde siempre</button>
                                                </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_17'>Indique si es
                                                    miliciano</span>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_18'>Indique el tipo de
                                                    transporte</span>
                                                <table style="width:100%">
                                                    <tr>
                                                        ...
                                                        <td style='display:none' id='tipo_transporte_view'>
                                                            ...
                                                            <input type="text" id='tipo_transporte'
                                                                name="tipo_transporte"
                                                                placeholder="Indique el tipo de transporte"
                                                                class="form-control" list='transportes_regitrados'
                                                                oninput="Limitar(this,12)">

                                                            <datalist id='transportes_regitrados'>
                                                                <?php foreach ($this->transportes as $tr) { ?>
                                                                <option
                                                                    value="<?php echo $tr['descripcion_transporte']; ?>">
                                                                </option>
                                                                <?php } ?>
                                                            </datalist>
                                                ...
                                                <table style="width:100%">
                                                    <tr>
                                                        ...
                                                        <td style='display:none' id='comunidad_indigena_view'>
                                                            ...
                                                            <input type="text" id='nombre_comunidad'
                                                                name="nombre_comunidad"
                                                                placeholder="Nombre de la comunidad indigena"
                                                                class="form-control solo-letras"
                                                                list='comunidades_indigenas' oninput="Limitar(this,20)">

                                                            <datalist id='comunidades_indigenas'>
                                                                <?php foreach ($this->comunidades as $cm) { ?>
                                                                <option value="<?php echo $cm['nombre_comunidad']; ?>">
                                                                </option>
                                                                <?php } ?>
                                                            </datalist>
                                    ...
                                    <div class="tab-pane" id="panel2" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control mb-10 no-acentos no-espacios"
                                                        id="serial_patria" name="datos[serial_patria]"
                                                        placeholder="Serial" type="text" oninput="Limitar(this,10)" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control mb-10 no-acentos no-espacios"
                                                        id="serial_psuv" name="datos[serial_psuv]" placeholder="Serial"
                                                        type="text" oninput="Limitar(this,12)" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control mb-10 no-acentos no-espacios"
                                                        id="codigo_patria" name="datos[codigo_patria]"
                                                        placeholder="Codigo" type="text" oninput="Limitar(this,10)" />
                                                </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control mb-10 no-acentos no-espacios "
                                                        id="codigo_psuv" name="datos[codigo_psuv]" placeholder="Codigo"
                                                        type="text" oninput="Limitar(this,12)" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 mt-2">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control mb-10 no-acentos no-espacios "
                                                        id="serial_discapacidad" name="datos[serial_discapacidad]"
                                                        placeholder="Serial" type="text" oninput="Limitar(this,12)" />
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control mb-10 no-acentos no-espacios"
                                                        id="codigo_discapacidad" name="datos[codigo_discapacidad]"
                                                        placeholder="Codigo" type="text" oninput="Limitar(this,12)" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="panel3" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_21'>Ingrese el número de
                                                    teléfono</span>
                                                <div class="input-group">
                                                    <input class="form-control mb-10 solo-numeros no-espacios"
                                                        id="telefono" name="datos[telefono]" placeholder="0000-000-0000"
                                    ...
                                    <div class="tab-pane" id="panel4" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_23'>Indique si pertenece
                                                    a una org. política</span>
                                                <table style="width:100%">
                                                    <tr>
                                                        <td>
                                                            <div class="input-group">
                                                                <select class="custom-select" id="organizacion_politica"
                                                                    name="datos[organizacion_politica]">
                                                                    <option selected="" value="0">
                                                                        Ninguna
                                                                    </option>
                                                                    <?php foreach ($this->organizaciones as $org) { ?>
                                                                    <option
                                                                        value="<?php echo $org['id_org_politica']; ?>">
                                                                        <?php echo $org['nombre_org']; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                                <input style='display:none' type="text"
                                                                    id='nombre_organizacion' class='form-control'
                                                                    placeholder="Escriba el nombre de la organización"
                                                                    name="" oninput="Limitar(this,35)">
                                                            </div>
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_24'>Ingrese el nombre del
                                                    bono</span>
                                                <table style="width:100%">
                                                    <tr>
                                                        <td><br>
                                                            <div class="input-group">
                                                                <select id='input_bonos' class='form-control'>
                                                                    ...
                                                                    <option value="<?php echo $b['id_bono']; ?>">
                                                                        <?php echo $b['nombre_bono'];?></option>
                                                                    <?php  } ?>
                                                                </select>

                                                                <input style='display:none' type="text" id='bono_nuevo'
                                                                    name="bono_nuevo" class='form-control'
                                                                    placeholder="Nombre del bono"
                                                                    oninput="Limitar(this,25)">
                                                            </div>
                                                        </td>
                                                        <td><br>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="text-align:center"><br>
                                                            <div style='width:80%;border-radius: 6px;height: 250px !important;background:#B8F1FF;overflow-y: scroll'
                                                                id='bonos_agregados'>
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_25'>Ingrese el nombre de
                                                    la misión</span>
                                                <table style="width:100%">
                                                    <tr>
                                                        <td>
                                                            Nombre misión
                                                            <div class="input-group">
                                                                <input type="text" id='nombre_mision'
                                                                    style='display:none' class='form-control'
                                                                    placeholder="Nombre de la misión"
                                                                    oninput="Limitar(this,30)">
                                                                <select class='form-control' id='input_misiones'>
                                                                    <option value='vacio'>-Seleccione-</option>
                                                                    <?php foreach ($this->misiones as $m) { ?>
                                                                    <option value="<?php echo $m['id_mision']; ?>">
                                                                        <?php echo $m['nombre_mision'];?></option>
                                                                    <?php  } ?>
                                                                </select>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td style='display:none' id='ver_fecha_recepcion'>Última vez
                                                            recibido
                                                            <input type="date" id='ultima_recepcion'
                                                    ...
                                                    <tr>
                                                        <td colspan="4" style="text-align:center"><br>
                                                            <div style='width:80%;border-radius: 6px;height: 250px !important;background:#B8D7FF;overflow-y: scroll'
                                                                id='misiones_agregadas'>
                                    ...
                                    <div class="tab-pane" id="panel5" role="tabpanel">
                                        ...
                                        <div class="row  mt-2">
                                            ...
                                            <div class="col-md-12 mt-2">
                                                ...
                                                <span style='display:none;color:red' id='valid_26'>Ingrese la
                                                    ocupación</span>
                                                <table style='width:100%'>
                                                    <tr>
                                                        <td>
                                                            <div class="input-group">
                                                                <select id='ocupacion' class='form-control'>
                                                                    ...
                                                                    <option value='<?php echo $o["id_ocupacion"]; ?>'>
                                                                        <?php echo $o['nombre_ocupacion'];?></option>
                                                                    <?php  } ?>
                                                                </select>

                                                                <input style='display:none' type="text"
                                                                    class='form-control' id='ocupacion_nueva'
                                                                    name="ocupacion"
                                                                    placeholder="Ocupación de la persona"
                                                                    oninput="Limitar(this,20)">
                                                            </div>
                                                        </td>
                                                        <td><input type="button" id='btn_nueva_ocupacion'
                                                                class='btn btn-info' value='Nueva' name=""></td>
                                                    </tr>
                                                </table>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    ...
                                                    <span style='display:none;color:red' id='valid_27'>Campo sin
                                                        llenar</span>
                                                    <table style='width:100%'>
                                                        <tr>
                                                            <td>
                                                                <div class="input-group">
                                                                    ...
                                                                    <select class='form-control'
                                                                        id="nombre_condicion_laboral">
                                                                        <option value='0'>Desempleado</option>
                                                                        <?php foreach ($this->condiciones as $cond) { ?>
                                                                        <option
                                                                            value='<?php echo $cond["nombre_cond_laboral"]; ?>'>
                                                                            <?php echo $cond['nombre_cond_laboral'];?>
                                                                        </option>
                                                                        <?php      } ?>
                                                                    </select>
                                                                    <input style='display:none'
                                                                        class='form-control solo-letras' type="text"
                                                                        id='nombre_cond_nueva'
                                                            ...
                                                            <td style='display:none' id='ver_sector_formal'>
                                                                <select class="form-control" id="tipo_sector_formal"
                                                                    ...
                                                                    <option value='vacio'>-Tipo de sector formal-
                                                                    </option>
                                                                    <option value="1">
                                                                        Informal
                                                                    </option>
                                                            ...
                                                            <td>
                                                                <input type="button" class='btn btn-info'
                                                                    id='nueva_cond' value='Nueva' name="">
                                                            </td>
                                                            ...
                                                            <td style='width:120%'>
                                                                ...
                                                                <div id='proyectos_agregados'>
                                                                    <select class="form-control" id="proyectos"
                                                                        ...
                                                                        <option
                                                                            value="<?php echo $pr['id_proyecto']; ?>">
                                                                            <?php echo $pr['nombre_proyecto']; ?>
                                                                        </option>
                                                                        <?php   } ?>
                                                                    </select>
                                                                </div>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text" id='nombre_proyecto'
                                                                                    ...
                                                                                    class='form-control'
                                                                                    oninput="Limitar(this,40)">
                                                                            </td>
                                                                            <td>
                                                                                <select id='area_proyecto'
                                                                                    class='form-control'>
                                                                                    ...
                                                                                    <option value='Comunicación'>
                                                                                        Comunicación</option>
                                                                                    <option value='Textil o Artesanal'>
                                                                                        Textil o Artesanal</option>
                                                                                    <option value='Agricola'>Agricola
                                                                                    </option>
                                                                            ...
                                                                            <td>
                                                                                <input type="text" id='estado_proyecto'
                                                ...
                                                <div class="col-md-10 mt-2"
                                                    style='border-radius: 6px;overflow-y: scroll;background: #CFFEDE;width: 100%;height: 200px !important'
                                                    id='proyectos_persona'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mt-2">
                                                <div class="form-group">
                                                    <label for="correo">
                                                        Contraseña
                                                    </label> <span id='valid_contrasenia'
                                                        style='color:red;display:none'>Debe ingresar la contraseña del
                                                        usuario</span>
                                                    <div class="input-group">
                                                        <table style='width:100%'>
                                                            <tr>
                                                                <td>
                                                                    <input class="form-control no-espacios"
                                                                        id="contrasenia" name=""
                                                                        placeholder="Contraseña de ingreso"
                                                                        type="password" oninput="Limitar(this,10)">
                                                                </td>
                                                                <td><button type='button' class='btn btn-default'
                                                                        id='ver_clave'><em
                                                                            class='fa fa-eye'></em></button></td>
                                                            </tr>
                                                        </table>
                                                        </table>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <div class="form-group">
                                                        ...
                                                        </label> <span id='valid_confirmar'
                                                            style='color:red;display:none'>Debe confirmar la contraseña
                                                            del usuario</span>
                                                        <div class="input-group">
                                                            <input class="form-control no-espacios" id="confirmar"
                                                                name="" placeholder="Contraseña de ingreso"
                                                                type="password" oninput="Limitar(this,10)">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span style='display:none;color:red'
                                                                        id='valid_color'>Ingrese el color
                                                                        favorito</span>
                                                                    <div class="input-group">
                                                                        <input
                                                                            class="form-control mb-10 solo-letras no-espacios"
                                                                            id="color_fav" placeholder="Color favorito"
                                                                            type="text" maxlength="12"
                                                                            oninput="Limitar(this,8)" />
                                                                    </div>
                                                                </td>

                                                                <td>
                                                                    <span style='display:none;color:red'
                                                                        id='valid_animal'>Ingrese el animal
                                                                        favorito</span>
                                                                    <div class="input-group">
                                                                        <input
                                                                            class="form-control mb-10 solo-letras no-espacios"
                                                                            id="animal_fav"
                                                                            placeholder="Animal favorito" type="text"
                                                                            maxlength="12" oninput="Limitar(this,10)" />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <span style='display:none;color:red'
                                                                        id='valid_mascota'>Ingrese el nombre de la
                                                                        primera mascota</span>
                                                                    <div class="input-group">
...
<script type="text/javascript" src="<?php echo constant('URL')?>config/js/news/registrar-personas-habitante.js">
</script>
<style>
