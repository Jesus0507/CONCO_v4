                                ...
                                success: function(direccion_segura) {
                                    $.ajax({
                                        ...
                                        $(document).on('click', '#agregar', function() {
                                            ...
                                            var div_enfermedaedes = document
                                                .getElementById(
                                                    "enfermedades_agregadas");
                                            if ((enfermedad_input.style.display !=
                                                    'none' && enfermedad_input
                                                    .value == '') || (
                                                    enfermedad_input.style
                                                    .display == 'none' &&
                                                    enfermedad_select.value ==
                                                    'vacio')) {
                                                valid_enfermedad.innerHTML =
                                                    'Ingrese la enfermedad';
                                                ...
                                                var textoEnfermedad = "";
                                                var textoMedicamento = medicamentos
                                                    .value;
                                                enfermedad_input.style.display !=
                                                    'none' ? enfer['enfermedad'] =
                                                    enfermedad_input.value : enfer[
                                                        'enfermedad'] =
                                                    enfermedad_select.value;
                                                enfermedad_input.style.display !=
                                                    'none' ? textoEnfermedad =
                                                    enfermedad_input.value :
                                                    textoEnfermedad =
                                                    enfermedad_select.options[
                                                        enfermedad_select
                                                        .selectedIndex].text;
                                                enfermedad_input.style.display !=
                                                    'none' ? enfer['nuevo'] = '1' :
                                                    enfer['nuevo'] = '0';
                                                textoMedicamento == '' ? enfer[
                                                        'medicamentos'] =
                                                    "No posee" : enfer[
                                                        'medicamentos'] =
                                                    textoMedicamento;
                                        ...
                                        $(document).on('click', '#enviar', function() {
                                            $.ajax({
                                                ...
                                                data: {
                                                    ...
                                                    peticion: "Registrar",
                                                    sql: "SQL_05",
                                                    accion: "Se ha Actualizado el  Enfermo pordator de la Cedula: " +
                                                        $('#cedula').val(),
                                                },
