        ...
        <div class="col-11">
            <div class="card card-outline card-primary card-outline-tabs">
                <div class="card-header text-center">
                    <h2 class="tipogra">Consejo Comunal </h2>
                    <h2 >   Prados de Occidente</h2>
                </div>
                    ...
                    <div class="tab-content" id="custom-tabs-three-tabContent">
                            ...
                            <form action="<?php Direcciones::_042_(); ?>" method="POST"
                                ...
                                <div class="input-group mb-3">
                                    <input
                                        ...
                                        type="number" maxlength="9" class="form-control" id="cedula"
                                        placeholder="Usuario" name="cedula_usuario">
                                ...
                                <div class="input-group mb-3">
                                    <input type="password" class="form-control contraseña" placeholder="Contraseña"
                                        id="contrasenia" name="datos[password]">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <a href="javascript:void(0);" type="button" class="btn"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 mt-2">
                                        <input type="button" class="btn btn-primary btn-block" id="enviar"
                                            value="Entrar">
                                    </div>
                                    <div class="col-6 mt-2">
                        ...
                        <div class="tab-pane fade" id="constancia2" role="tabpanel" aria-labelledby="constancia">
                            ...
                            <table style="width:100%">
                                <tr>
                                    <td> <input type="number" maxlength="8" name="cedulaPersona" id="cedulaPersona"
                                            class="form-control" placeholder="Ingrese su cédula"></td>
                                </tr>
                            </table>
                            ...
                            <button type='button' id="consultaPersona" class='btn btn-primary'
