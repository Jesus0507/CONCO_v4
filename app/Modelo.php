...
class Modelo extends BASE_DATOS
{
    ...
    protected function _08_(): string
    {
        return "SELECT COUNT(*) AS count FROM " . $this->crud['consultar']['tabla'] . " WHERE " . $this->crud['consultar']['columna'] . " = :".$this->crud['consultar']['data']." AND estado = 1";
    }
}
