...
return array(
    'Agenda' => $baseDir . '/controlador/agenda_controlador.php',
    'AgendaTest' => $baseDir . '/tests/AgendaTest.php',
    'Agenda_Class' => $baseDir . '/modelo/agenda_class.php',
    'Ayuda' => $baseDir . '/controlador/ayuda_controlador.php',
    'Ayuda_Class' => $baseDir . '/modelo/ayuda_class.php',
    'BASE_DATOS' => $baseDir . '/app/Base_Datos.php',
    'Base_DatosTest' => $baseDir . '/tests/Base_DatosTest.php',
    'Bitacora' => $baseDir . '/controlador/bitacora_controlador.php',
    'Bitacora_Class' => $baseDir . '/modelo/bitacora_class.php',
    'CallesTest' => $baseDir . '/tests/CallesTest.php',
    'Centro_Votacion' => $baseDir . '/controlador/centro_votacion_controlador.php',
    'Centro_VotacionTest' => $baseDir . '/tests/Centro_VotacionTest.php',
    'Centro_Votacion_Class' => $baseDir . '/modelo/centro_votacion_class.php',
    'Centro_Votacion_Validacion' => $baseDir . '/controlador/backend/centro_votacion_validacion.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'Consejo_Comunal' => $baseDir . '/controlador/consejo_comunal_controlador.php',
    'Consejo_ComunalTest' => $baseDir . '/tests/Consejo_ComunalTest.php',
    'Consejo_Comunal_Class' => $baseDir . '/modelo/consejo_comunal_class.php',
    'Consejo_Comunal_Validacion' => $baseDir . '/controlador/backend/consejo_comunal_validacion.php',
    'Contacto' => $baseDir . '/controlador/contacto_controlador.php',
    'Contacto_Class' => $baseDir . '/modelo/contacto_class.php',
    ...
    'Direcciones' => $baseDir . '/app/Direcciones.php',
    'Discapacitados' => $baseDir . '/controlador/discapacitados_controlador.php',
    'DiscapacitadosTest' => $baseDir . '/tests/DiscapacitadosTest.php',
    'Discapacitados_Class' => $baseDir . '/modelo/discapacitados_class.php',
    'Discapacitados_Validacion' => $baseDir . '/controlador/backend/discapacitados_validacion.php',
    ...
    'Enfermos' => $baseDir . '/controlador/enfermos_controlador.php',
    'EnfermosTest' => $baseDir . '/tests/EnfermosTest.php',
    'Enfermos_Class' => $baseDir . '/modelo/enfermos_class.php',
    'Enfermos_Validacion' => $baseDir . '/controlador/backend/enfermos_validacion.php',
    'Errores' => $baseDir . '/controlador/error_controlador.php',
    'Familias' => $baseDir . '/controlador/familias_controlador.php',
    'FamiliasTest' => $baseDir . '/tests/FamiliasTest.php',
    'Familias_Class' => $baseDir . '/modelo/familias_class.php',
    'Familias_Validacion' => $baseDir . '/controlador/backend/familias_validacion.php',
    ...
    'Grupos_Deportivos' => $baseDir . '/controlador/grupos_deportivos_controlador.php',
    'Grupos_DeportivosTest' => $baseDir . '/tests/Grupos_DeportivosTest.php',
    'Grupos_Deportivos_Class' => $baseDir . '/modelo/grupos_deportivos_class.php',
    'Grupos_Deportivos_Validacion' => $baseDir . '/controlador/backend/grupos_deportivos_validacion.php',
    'Habitante' => $baseDir . '/controlador/habitante_controlador.php',
    'Habitante_Class' => $baseDir . '/modelo/habitante_class.php',
    'Iniciar_Sistema' => $baseDir . '/app/App.php',
    'Inicio' => $baseDir . '/controlador/inicio_controlador.php',
    'Inicio_Class' => $baseDir . '/modelo/inicio_class.php',
    'Inmuebles' => $baseDir . '/controlador/inmuebles_controlador.php',
    'InmueblesTest' => $baseDir . '/tests/InmueblesTest.php',
    'Inmuebles_Class' => $baseDir . '/modelo/inmuebles_class.php',
    'Inmuebles_Validacion' => $baseDir . '/controlador/backend/inmuebles_validacion.php',
    'InternetPixels\\SodiumEncryption\\EncryptionManager' => $vendorDir . '/internetpixels/sodium-encryption/src/EncryptionManager.php',
    'InternetPixels\\SodiumEncryption\\Tests\\EncryptionManagerTest' => $vendorDir . '/internetpixels/sodium-encryption/tests/EncryptionManagerTest.php',
    'Login' => $baseDir . '/controlador/login_controlador.php',
    'LoginTest' => $baseDir . '/tests/LoginTest.php',
    'Login_Class' => $baseDir . '/modelo/login_class.php',
    'Login_Validacion' => $baseDir . '/controlador/backend/login_validacion.php',
    'Modelo' => $baseDir . '/app/Modelo.php',
    'Negocios' => $baseDir . '/controlador/negocios_controlador.php',
    'NegociosTest' => $baseDir . '/tests/NegociosTest.php',
    'Negocios_Class' => $baseDir . '/modelo/negocios_class.php',
    'Negocios_Validacion' => $baseDir . '/controlador/backend/negocios_validacion.php',
    'Notificaciones' => $baseDir . '/controlador/notificaciones_controlador.php',
    'NotificacionesTest' => $baseDir . '/tests/NotificacionesTest.php',
    'Notificaciones_Class' => $baseDir . '/modelo/notificaciones_class.php',
    ...
    'PartoHumanizadoTest' => $baseDir . '/tests/Parto_HumanizadoTest.php',
    'Parto_Humanizado' => $baseDir . '/controlador/parto_humanizado_controlador.php',
    'Parto_Humanizado_Class' => $baseDir . '/modelo/parto_humanizado_class.php',
    'Parto_Humanizado_Validacion' => $baseDir . '/controlador/backend/parto_humanizado_validacion.php',
    'Personas' => $baseDir . '/controlador/personas_controlador.php',
    'PersonasTest' => $baseDir . '/tests/PersonasTest.php',
    'Personas_Class' => $baseDir . '/modelo/personas_class.php',
    ...
    'Reportes' => $baseDir . '/controlador/reportes_controlador.php',
    'ReportesTest' => $baseDir . '/tests/ReportesTest.php',
    'Reportes_Class' => $baseDir . '/modelo/reportes_class.php',
    ...
    'Sector_Agricola' => $baseDir . '/controlador/sector_agricola_controlador.php',
    'Sector_AgricolaTest' => $baseDir . '/tests/Sector_AgricolaTest.php',
    'Sector_Agricola_Class' => $baseDir . '/modelo/sector_agricola_class.php',
    'Sector_Agricola_Validacion' => $baseDir . '/controlador/backend/sector_agricola_validacion.php',
    'Seguridad' => $baseDir . '/controlador/seguridad_controlador.php',
    'SeguridadTest' => $baseDir . '/tests/SeguridadTest.php',
    'Seguridad_Class' => $baseDir . '/modelo/seguridad_class.php',
    'Solicitudes' => $baseDir . '/controlador/solicitudes_controlador.php',
    'SolicitudesTest' => $baseDir . '/tests/SolicitudesTest.php',
    'Solicitudes_Class' => $baseDir . '/modelo/solicitudes_class.php',
    ...
    'Usuario' => $baseDir . '/controlador/usuario_controlador.php',
    'Usuario_Class' => $baseDir . '/modelo/usuario_class.php',
    'Usuario_Validacion' => $baseDir . '/controlador/backend/usuario_validacion.php',
    'Vacunados_Validacion' => $baseDir . '/controlador/backend/vacunados_validacion.php',
    'Validacion' => $baseDir . '/app/Validacion.php',
    'Vista' => $baseDir . '/app/Vista.php',
    'Viviendas' => $baseDir . '/controlador/viviendas_controlador.php',
    'ViviendasTest' => $baseDir . '/tests/ViviendasTest.php',
    'Viviendas_Class' => $baseDir . '/modelo/viviendas_class.php',
    'Viviendas_Validacion' => $baseDir . '/controlador/backend/viviendas_validacion.php',
