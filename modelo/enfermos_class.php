...
class Enfermos_Class extends Modelo
{
    ...
    public function Administrar()
    {
        ...
        try {
            ...
            return $this->Capturar_Error($e, "Enfermos"); 
        }
    }
    ...
    {
        return "SELECT E.*,PE.cedula_persona,PE.medicamentos, PE.id_persona_enfermedad FROM enfermedades E, personas_enfermedades PE WHERE PE.cedula_persona = $this->id AND PE.id_enfermedad=E.id_enfermedad AND E.estado=1";
    }
