    ...
    public function Administrar($peticion = null)
    {
        ...
        switch ($peticion) {
            ...
            case 'Consultas':
                ...
                break;
            case 'Consulta_Ajax':$this->Escribir_JSON($this->Get_Datos_Vista()["parto_humanizado"]);
                break;
            ...
            case 'Registrar':
                if ($this->permisos["registrar"] === 1) {
                    ...
                    if ($this->validacion->Validacion_Registro()) {
                        ...
                        foreach ($this->datos_consulta["parto_humanizado"] as $key => $value) {
                            if ($value["cedula_persona"] == $this->datos_ejecutar["cedula_persona"]) {
                                $existe = true;
                            }
                        }
                        if (!$existe) {
                           ...
                           echo "Esta persona ya se encuentra registrada"; 
                        }
                    } else {
            ...
            case 'Existente':
                ...
                if (count($this->consulta) == 0 || $this->consulta[0]['estado'] == 0 || $this->consulta[0]['estado'] == 2) {
                    ...
                    if ($this->consulta[0]['genero'] == 'M') {$this->respuesta = "Esta cédula no es válida, su propietario es masculino.";} else { $this->respuesta = 1;}
                }
