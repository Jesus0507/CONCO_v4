                                        ...
                                        if ($this->Comprobar($_POST["datos"]["necesidades"])) {
                                                    ...
                                                    if ($this->Validar_Caracteres($_POST["datos"]["necesidades"])) {
                                                        ...
                                                        if ($this->Validar_Estado($_POST["datos"]["estado"])) {
                                                            ...
                                                            $_POST["datos"] = array(
                                                                "cedula"             => $this->Datos_Limpios($_POST["datos"]["cedula"]),
                                                                "discapacidad"       => $this->Datos_Limpios($_POST["datos"]["discapacidad"]),
                                                                "necesidades"        => $this->Datos_Limpios($_POST["datos"]["necesidades"]),
                                                                "observaciones"      => $this->Datos_Limpios($_POST["datos"]["observaciones"]),
                                                                "en_cama"            => $this->Datos_Limpios($_POST["datos"]["en_cama"]),
